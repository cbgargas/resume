...
Very experienced in data wrangling, data management, exploratory analysis, statistical analysis, and Data visualization.

Experienced with short- and long-read NGS data analysis.

Experienced with phylogenetics and microbiome analysis.

Disclaimer {#disclaimer}
--------------------------------------------------------------------------------

Resume created using the Quarto & the R package [**pagedown**](https://github.com/rstudio/pagedown).
